      ...
      this.slides = [
        {
          ...
          image: 'images/new-slider-imgs/deep freeze.webp',
          routerLink: '/brand/24',
          vectorImage: 'images/slider vectors/Vector (2).webp',
          slideClass: 'slide-1 radial',
        },
        {
          title: slides[1]?.title || 'Deep Heat',
          image: 'images/new-slider-imgs/deep heat.webp',
          routerLink: '/brand/23',
          vectorImage: 'images/slider vectors/Vector (3).webp',
          slideClass: 'slide-2 radial-2',
        },
        {
          title: slides[2]?.title || 'Hada Labo',
          image: 'images/new-slider-imgs/hada labo.webp',
          routerLink: '/brand/26',
          vectorImage: 'images/slider vectors/Vector (4).webp',
          slideClass: 'slide-3 radial-3',
        },
        {
          title: slides[3]?.title || 'Deep Relief',
          image: 'images/new-slider-imgs/deep relief.webp',
          routerLink: '/brand/25',
          vectorImage: 'images/slider vectors/Vector (5).webp',
          slideClass: 'slide-4 radial-4',
        },
        {
          title: slides[0]?.title || 'Rohto',
          image: 'images/new-slider-imgs/rohto.webp',
          routerLink: '/brand/27',
          vectorImage: 'images/slider vectors/Vector (6).webp',
