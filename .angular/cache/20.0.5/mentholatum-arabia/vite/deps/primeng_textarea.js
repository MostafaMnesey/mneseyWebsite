...
var theme = ar`
    ...
    .p-textarea.ng-invalid.ng-dirty {
        border-color: ${P("textarea.invalid.border.color")};
    }
    .p-textarea.ng-invalid.ng-dirty::placeholder {
        color: ${P("textarea.invalid.placeholder.color")};
    }
`;
var classes = {
  root: ({
...
var Textarea = class _Textarea extends BaseEditableHolder {
  /**
